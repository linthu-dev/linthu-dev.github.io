 ...
 const projects = [
   ...
   },
   {
     ...
     description: "Real-time chat app with AI-powered responses, built with WebSockets and OpenAI API.",
   ...
   },
   {
     ...
     description: "CLI tool that generates beautiful portfolio websites from JSON configuration.",
     tags: ["Node.js", "CLI", "Templates"],
     github: "https://github.com",
   },
   {
     title: "Weather Dashboard",
     description: "Weather app with location detection, forecasts, and beautiful data visualizations.",
   ...
   {
     title: "URL Shortener",
     description: "Fast URL shortening service with analytics and custom aliases.",
     tags: ["Express", "Redis", "Analytics"],
     github: "https://github.com",
   },
 ];
